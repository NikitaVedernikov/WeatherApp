...
public final class ActivityAddBinding implements ViewBinding {
  ...
  private ActivityAddBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull TextView cityView, @NonNull LinearLayout linearLayout, @NonNull Spinner spinner6,
  ...
  public static ActivityAddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddBinding((ConstraintLayout) rootView, button, cityView, linearLayout,
          spinner6, textView7);
    }
